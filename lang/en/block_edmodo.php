...
$string['qq_exportlink'] = 'Create and download Moodle questions(XML)<br />';
$string['qq_direct_exportlink'] = 'Create and import to Moodle question bank<br />';
$string['qq_create_quiz'] = 'Make quizzes from Moodle question bank<br />';
...
$string['quizzes_processed'] = 'Quizzes Processed: {$a}';
...
$string['createquizinstructions'] = "Choose the start category from which to create quizzes, and the course topic/section in which to create them. For each category or sub category that contains questions, a quiz in the course will be created.";
...
$string['use_category'] = "Start Category";
...
$string['useddmatch']='Replace Matching with DDMatch';
$string['useddmatch_desc']='Edmodo matching questions are drag-and-drop. Moodle matching questions are not. Also Moodle matching question answers do not support Latex notation. If you need drag-and-drop or Latex notation support in the answer options, you should install the 3rd party question type plugin DDMatch. Then select "Replace Matching with DDMatch" here and the exported question will be DDMatch format. If you do not understand this, or do not have the ability to add new plugins to your Moodle site, then do not select this option.';
$string['questionsperpage']='Questions per quiz page';
